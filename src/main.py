...
shipimg = pygame.image.load('assets/images/galgadaship.png')
bg=pygame.image.load('assets/images/galgadab.png')

intros = [
	pygame.image.load('assets/images/introscreen.png'),
	pygame.image.load('assets/images/introscreen1.png'),
	pygame.image.load('assets/images/introscreen2.png'),
	pygame.image.load('assets/images/introscreen3.png')
]
...
def introscreen():
    gameDisplay.blit(intros[0],(0,0))
    pygame.display.update()
    pygame.mixer.music.load('assets/sounds/introsound2.mp3')
    pygame.mixer.music.play(0)
    time.sleep(1)
    gameDisplay.blit(intros[1],(0,0))
    pygame.display.update()
    time.sleep(1)
    gameDisplay.blit(intros[2],(0,0))
    pygame.display.update()
    time.sleep(1)
    gameDisplay.blit(intros[3],(0,0))
    pygame.display.update()
    time.sleep(1)
...
def game_intro():
     introscreen()
     pygame.mixer.music.load('assets/sounds/spaceavoiders.mp3')
...
def game_loop():
    ...
    pygame.mixer.music.load('assets/sounds/spaceavoidersbg.mp3')
    pygame.mixer.music.play(-1)
